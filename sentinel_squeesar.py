...
###########################################
    ...
    if flag == 'patchlist_created':
        ...
        cmd = '$INT_SCR/split_jobs.py -f ' + inps.sq_dir + '/run_PSQ_sentinel -w 10:00 -r 3000 -q '+ jobqueue 
    ...
    cmd = '$INT_SCR/split_jobs.py -f ' + inps.project_dir + '/merged/run_write_SLC -w 5:00 -r 5000 -q '+ jobqueue 
