...
cdef float[:,::1] outer_product_float(float[::1], float[::1])
#cdef float complex[:,::1] divide_elementwise(float complex[:, ::1], float complex[:, ::1])
cdef float complex[:,::1] divide_elementwise_float(float complex[:, ::1], float [:, ::1])
...
cpdef tuple phase_linking_process_py(float complex[:, ::1], int, bytes, bint)
