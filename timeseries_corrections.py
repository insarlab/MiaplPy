...
EXAMPLE = """example:
  timeseries_corrections.py                         #run with default template 'smallbaselineApp.cfg'
  timeseries_corrections.py <custom_template>       #run with default and custom templates
  timeseries_corrections.py -h / --help             #help
  timeseries_corrections.py -H                      #print    default template options
  timeseries_corrections.py -g                      #generate default template if it does not exist
  timeseries_corrections.py -g <custom_template>    #generate/update default template based on custom template

  # Run with --start/stop/dostep options
  timeseries_corrections.py GalapagosSenDT128.template --dostep velocity  #run at step 'velocity' only
  timeseries_corrections.py GalapagosSenDT128.template --end load_data    #end after step 'load_data'
"""
